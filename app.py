...
class ContextualChatbot:
    ...
    def generate_response(self,user_input):
        system_prompt="""
                ...
                Example response -> "Today, I’ve called regarding an emergency campaign. We’re running a Social Impact Plan (SIP), a monthly auto-debit donation initiative. This supports medical and educational needs for underprivileged children. Contributions can be as small as ₹200-₹300, and they come with an 80G tax benefit."
